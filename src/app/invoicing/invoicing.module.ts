...
@NgModule({
  declarations: [InvoicePositionsComponent, InvoiceComponent, SinglePositionComponent, InvoiceSummaryComponent, InvoiceClientComponent, InvoiceDetailsComponent],
  imports: [
    CommonModule,
    FormsModule,
    HttpClientModule
